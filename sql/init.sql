...
CREATE TABLE room (
  ...
  CHECK (location = 'Atlanta' OR location = 'Charlotte' OR location = 'Savannah' OR location = 'Orlando' OR
         location = 'Miami'),
...
CREATE TABLE reservation (
  ...
  FOREIGN KEY (card_no) REFERENCES payment (card_no) ON DELETE SET NULL,
  FOREIGN KEY (username) REFERENCES customer (username)
);
